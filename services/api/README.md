...
#### Admin Dashboard
```typescript
GET    /api/apps/admin/dashboard      // Get dashboard data
GET    /api/apps/admin/orders         // Get all orders
GET    /api/apps/admin/users          // Get all users
GET    /api/apps/admin/products       // Get all products
GET    /api/apps/admin/analytics      // Get admin analytics
```

#### Inventory Management
```typescript
GET    /api/apps/admin/inventory      // Get inventory status
PUT    /api/apps/admin/inventory/:id  // Update inventory
POST   /api/apps/admin/inventory/adjust // Adjust inventory
GET    /api/apps/admin/inventory/low-stock // Get low stock items
```
