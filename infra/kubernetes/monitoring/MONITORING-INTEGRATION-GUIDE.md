...
**Location:** `infra/kubernetes/monitoring/`
...
✅ Admin credentials: apps/admin/admin123
```
...
**Location:** `apps/client/src/lib/health-check.ts`
```typescript
...
##### **Metrics Endpoints**
**Location:** `apps/client/src/lib/performance-monitor.ts`
```typescript
...
**Location:** `infra/kubernetes/production/frontend.yaml`
```yaml
annotations:
...
kubectl apply -f infra/kubernetes/monitoring/alertmanager.yaml
kubectl apply -f infra/kubernetes/monitoring/jaeger.yaml
```
