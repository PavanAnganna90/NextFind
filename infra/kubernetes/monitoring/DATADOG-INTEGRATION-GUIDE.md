...
**Location:** `infra/kubernetes/monitoring/datadog.yaml`
...
**Location:** `apps/client/src/lib/datadog.ts`
...
kubectl apply -f infra/kubernetes/monitoring/datadog.yaml -n monitoring
