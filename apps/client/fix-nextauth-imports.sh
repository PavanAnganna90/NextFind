...
files=(
  "temp-apps/admin/orders/[id]/page.tsx"
  "temp-apps/admin/checkout/page.tsx"
  "temp-apps/admin/wishlist/page.tsx"
  "temp-apps/admin/orders/page.tsx"
  "temp-apps/admin/cart/page.tsx"
)
