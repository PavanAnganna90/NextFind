import { PUT as adminReviewPUT } from '@/app/api/apps/admin/reviews/[reviewId]/route'
import { GET as adminReviewsGET } from '@/app/api/apps/admin/reviews/route'
...
describe('GET /api/apps/admin/reviews', () => {
  beforeEach(() => {
    jest.clearAllMocks()
  ...
  it('should return reviews for admin moderation', async () => {
    ...
    const request = new NextRequest('http://localhost/api/apps/admin/reviews?status=pending')
  ...
  it('should return 403 if user is not admin', async () => {
    ...
    const request = new NextRequest('http://localhost/api/apps/admin/reviews')
    const response = await adminReviewsGET(request)
    const data = await response.json()
...
describe('PUT /api/apps/admin/reviews/[reviewId]', () => {
  beforeEach(() => {
    jest.clearAllMocks()
    mockGetServerSession.mockResolvedValue({ user: { id: 'admin123', email: 'admin@example.com' } })
  })
  ...
  it('should approve a review', async () => {
    ...
    const request = new NextRequest('http://localhost/api/apps/admin/reviews/1', {
      method: 'PUT',
